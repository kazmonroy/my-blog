...
export default function Carrousel() {
  return (
    <section className='flex py-8 justify-center gap-5 sm:gap-8 z-10 sm:mx-8 sm:border-x-2 border-x-zinc-100/50 dark:border-x-zinc-50/5 bg-white dark:bg-zinc-900'>
